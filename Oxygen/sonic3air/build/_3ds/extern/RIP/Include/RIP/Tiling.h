...
/**
 * @brief Check whether the hardware supports a tiling operation.
 * @param[in] width Image width.
 * @param[in] height Image height.
 * @param[in] pixelFormat Image pixel format.
 * @result True if the combination of parameters is supported by the hardware, false otherwise.
 */
bool ripTilingCanUseHW(u16 width, u16 height, RIPPixelFormat pixelFormat);
