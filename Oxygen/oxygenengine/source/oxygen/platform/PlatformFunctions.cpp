...
#elif defined(PLATFORM_LINUX) || defined(PLATFORM_MAC) || defined(PLATFORM_ANDROID) || defined(PLATFORM_SWITCH) || defined(PLATFORM_IOS) || defined(PLATFORM_VITA) || defined(PLATFORM_3DS)
	#include <stdlib.h>
	#include <unistd.h>
	#include <sys/types.h>
	#include <pwd.h>
